...
describe('Turn', function() {
  ...
  it('should return a stated guess', function() {
  ...
  it('should return a given card', function() {
  ...
  it('should return a boolean based on legitimacy of the given answer', function() {
  ...
  it('Should give feedback based on if the given answer is true or false', function() {
